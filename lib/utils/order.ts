...
> = {
  ...
  REFUND_REQUESTED:  { label: 'Refund Requested',  colour: 'text-orange-600 dark:text-orange-400' },
  REFUND_DENIED:     { label: 'Refund Denied',     colour: 'text-red-600 dark:text-red-400'       },
};
